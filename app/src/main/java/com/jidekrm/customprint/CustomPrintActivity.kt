package com.jidekrm.customprint
...
import com.jidekrm.customprint.databinding.ActivityCustomPrintBinding
import java.io.FileOutputStream
import java.io.IOException

class CustomPrintActivity : AppCompatActivity() {

    lateinit var binding: ActivityCustomPrintBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
//        setContentView(R.layout.activity_custom_print)

        binding = DataBindingUtil.setContentView(this, R.layout.activity_custom_print)
    ...
    inner class MyPrintDocumentAdapter(private var context: Context): PrintDocumentAdapter(){
        ...
        private fun drawPage(page: PdfDocument.Page, pageNumber: Int){
            ...
            //Print root view
            val hh = binding.mainMe
            hh.draw(page.canvas)
            paint.textSize = 14f

//            print individual text
            canvas.drawText(binding.mText.text.toString(), leftMargin.toFloat(), (titleBaseLine + 35).toFloat(), paint)
